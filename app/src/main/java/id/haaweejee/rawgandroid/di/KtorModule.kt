...
import id.haaweejee.rawgandroid.data.datasource.remote.service.RawgRemoteServiceImpl
...
object KtorModule {
    ...
    @Provides
    @Singleton
    fun provideRawgRemoteService(client: HttpClient): RawgRemoteService = RawgRemoteServiceImpl(client)
}
